...
button_calculate = tk.Button(root, text="Calculate", padx=10, pady=5)

batch_ammount_label.grid(row=0, column=0, padx=10, pady=1, sticky="w")
batch_entry.grid(row=0, column=1)

nic_level_label.grid(row=1, column=0, padx=10, pady=1, sticky="w")
nic_level_entry.grid(row=1, column=1)

flavor_amount_label.grid(row=2, column=0, padx=10, pady=1, sticky="w")
flavor_amount_entry.grid(row=2, column=1)

button_calculate.grid(row=100, column=0, columnspan=2, padx=200, pady=1)
